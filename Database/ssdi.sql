...
SELECT
  *
FROM RosterRow;
INSERT INTO Roster(professor_id, course_id)
VALUES(1, 1);
CREATE TABLE Survey (
    survey_id integer auto_increment not null primary key,
    prof_id int,
    course_id int,
    deadline datetime,
...
VALUES
  (
    '2',
    '{"type":"freeform",
        "answer":"2. not at all comfortable"}',
    '1'
  );
INSERT INTO Answers (survey_id, answer_object, roster_row_id)
VALUES
