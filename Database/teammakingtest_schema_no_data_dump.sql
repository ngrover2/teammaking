CREATE DATABASE  IF NOT EXISTS `teammakingtest` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `teammakingtest`;
-- MySQL dump 10.13  Distrib 5.7.17, for macos10.12 (x86_64)
--
-- Host: 127.0.0.1    Database: teammakingtest
-- ------------------------------------------------------
...
-- Dump completed on 2019-11-11 17:26:55
